...
- `docs/ai-agent/design/syntax.md` — 语法设计文档自身的示例
- `docs/ai-agent/design/type-system.md` — 类型系统文档
- `docs/ai-agent/design/standard-library.md` — 标准库文档
- `docs/ai-agent/design/roles-and-permissions.md` — 安全模型文档
- `docs/ai-agent/design/app-overview.md` — 应用概览
- `docs/ai-agent/design/feature-inventory.md` — 功能清单
- `docs/ai-agent/design/supply-chain-security.md` — 供应链安全
- `docs/ai-agent/architecture/system-baseline.md` — 系统基线
- `docs/ai-agent/architecture/module-boundaries.md` — 模块边界
- `docs/ai-agent/examples/*.md` — 语法使用示例
...
| 16 | 点调用 | `p.parent()`、`code.isSuccess`、`line.slice 5` | `Path.parent p`、`Process.ExitCode.isSuccess code`、`String.slice 5 line` |
...
- 审计规范见 `docs/ai-agent/context/conventions.md`
- 语法设计权威文档：`docs/ai-agent/design/syntax.md`
