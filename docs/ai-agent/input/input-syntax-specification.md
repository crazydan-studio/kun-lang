...
- 计划：`docs/ai-agent/plans/plan-syntax-overhaul.md`
- 设计文档：`docs/ai-agent/design/syntax.md` 全量重写
- 关联文档更新：`docs/ai-agent/design/type-system.md`、`docs/ai-agent/design/standard-library.md`、`docs/ai-agent/design/supply-chain-security.md`
- 示例同步：4 个示例文件全量重写
- 跟踪文档：`docs/ai-agent/backlog/index.md`、`docs/ai-agent/context/project-context.md`、`docs/ai-agent/design/feature-inventory.md`
