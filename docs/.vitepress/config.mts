    ...
    items: [
      ...
      },
      {
        ...
        items: [
          ...
          { text: 'Phase 5 计划第1轮审计', link: '/ai-agent/audits/audit-phase5-plan' },
          { text: 'Phase 5 计划第1轮（多维度）', link: '/ai-agent/audits/audit-phase5-plan-round1' },
          { text: 'Phase 5 计划第2轮（验证）', link: '/ai-agent/audits/audit-phase5-plan-round2' },
          { text: 'Phase 5 计划第3轮（深度）', link: '/ai-agent/audits/audit-phase5-plan-round3' },
          { text: 'Phase 5 计划第4轮（再验证）', link: '/ai-agent/audits/audit-phase5-plan-round4' },
          { text: 'Phase 5 计划第6轮（新视角）', link: '/ai-agent/audits/audit-phase5-plan-round6' },
          { text: 'Phase 5 计划第7轮', link: '/ai-agent/audits/audit-phase5-plan-round7' },
          { text: 'Phase 5 计划第8轮（内部一致）', link: '/ai-agent/audits/audit-phase5-plan-round8' },
          { text: 'Phase 5 计划第9轮', link: '/ai-agent/audits/audit-phase5-plan-round9' },
          { text: 'Phase 5 计划第10轮', link: '/ai-agent/audits/audit-phase5-plan-round10' },
          { text: 'Phase 5 计划第11–12轮', link: '/ai-agent/audits/audit-phase5-plan-round11-12' },
          { text: 'Phase 5 计划第13轮', link: '/ai-agent/audits/audit-phase5-plan-round13' },
        ],
      },
      {
        text: '开发日志',
        ...
        items: [
          ...
          { text: '设计审计修复', link: '/ai-agent/logs/log-2026-06-02-design-audit-fixes' },
          { text: 'CDF 编译期代码生成定稿', link: '/ai-agent/logs/log-2026-06-03-cdf-code-generation' },
          { text: 'CDF 类型/架构/语法层重构', link: '/ai-agent/logs/log-2026-06-04-cdf-rearchitecture' },
          { text: '语法打磨 + 8 轮审计', link: '/ai-agent/logs/log-2026-06-04-syntax-polish-audit-rounds' },
          { text: '全面审计修复 + 语法检查', link: '/ai-agent/logs/log-2026-06-06-comprehensive-audit-syntax-fixes' },
          { text: '架构评审与全面修复', link: '/ai-agent/logs/log-2026-06-07-comprehensive-review-and-fixes' },
          { text: '架构重设计与标准库重组讨论', link: '/ai-agent/logs/log-2026-06-11-design-discussions' },
        ],
      },
      {
        text: '测试记录',
