...
文档审计（`docs/skills/document-audit-prompt.md`）

## 审计范围

| 文件 | 角色 |
|------|------|
| `docs/design/type-system.md` | 主审对象 |
| `docs/design/feature-inventory.md` | 对照 |
| `docs/design/app-overview.md` | 对照 |
| `docs/architecture/system-baseline.md` | 对照 |
| `docs/architecture/module-boundaries.md` | 对照 |
| `docs/requirements/mvp.md` | 范围对照 |
